...
const RecordedDiplomaInBusiness = () => {
      ...
      if (button) {
        button.onclick = function (e) {
          var options: any = {
            ...
            notes: {
              item_name: "Recorded Diploma in business management course",
            ...
            <div className="row resip">
              ...
              <div className="col-lg-5 w">
                <div className="tabata d-inline-block">
                  <h1>Diploma in Business Management Course (Recorded)</h1>
                </div>
...
export default RecordedDiplomaInBusiness;
