...
export default function GamePage() {
  ...
  const games = [
    ...
    {
      name: "Super Color Lines Match 5",
  ...
  return (
    <div>
        ...
        <div className="background p-0 mx-auto">
          <div className=" text-white p-3 flex flex-col">
            ...
            <div className="py-5 flex justify-center items-center h-screen">
              <div
                className="w-full h-full bg-black rounded overflow-hidden shadow-lg relative"
              >
                ...
                {!iframeEnabled && (
                  <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/40">
                    <button
                      className="bg-red-600 hover:bg-red-700 text-white p-4 rounded-full flex items-center justify-center transition-colors"
                      onClick={handleFullscreen}
      ...
      <div className="container-fluid">
        <div
          className="text-white background p-3 "
            ...
            <div className="col-12">
              ...
              <div className="row g-3">
                {relatedGames.map((game, index) => (
                  <div key={`${game}-${index}`} className="col-6 col-sm-6 mb-4 cursor-pointer" style={{ flex: '0 0 20%' }}>
                    <Link href={game.link}>
